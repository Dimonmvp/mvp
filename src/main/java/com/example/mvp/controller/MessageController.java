...
import com.example.mvp.sevice.MessageService;
...
public class MessageController {
    ...
    public String main(
        ...
        Page<MessageDto> page = messageServise.messageList(pageable,filter,user);
    ...
    public String userMessges(
        ...
        Page<MessageDto> page = messageServise.messageListForUser(pageable,currentUser,author);
